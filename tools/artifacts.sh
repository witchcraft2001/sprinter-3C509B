...
IMG_ARTIFACTS=(
  ...
  "binary|build/TELNET.EXE|TELNET.EXE"
  ...
  "text|docs/TELNET.md|TELNET.TXT"
  "text|docs/DLSPEED.md|DLSPEED.TXT"
  "text|docs/NETPROF.md|NETPROF.TXT"
  ...
  "text|docs/STAGE14_TESTING_RU.md|S14TEST.TXT"
  "text|docs/UNET509B.md|UNET509B.TXT"
